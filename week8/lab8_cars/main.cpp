...
int main()
{
    ...
    } // End scope so a second Car object can be created without conflict.
#endif // TEST_CAR
...
#ifdef ADDITIONAL_CARS
    theList.moreCars();
#endif // ADDITIONAL_CARS
